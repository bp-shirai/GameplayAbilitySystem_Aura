...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	//UE_LOG(LogTemp, Warning, TEXT("[%s] GetTagName = %s"), TEXT(TO_STRING(Attributes_Primary_Strength)), *Attributes_Primary_Strength.GetTag().GetTagName().ToString());
...
void UAuraAttributeSet::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
	...
	UE_LOG(LogAura, Log, TEXT("PreAttributeChange [%s::%s] = %f"), *GetNameSafe(GetOwningActor()), *Attribute.GetName(), NewValue);
}
